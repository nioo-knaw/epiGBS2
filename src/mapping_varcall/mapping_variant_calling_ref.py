...
def run_STAR(in_files, args):
    ...
    cmd = ["python src/mapping_varcall/map_STAR_ref.py",
...
def merge_watson_crick(in_files, args, timeout=36000):
    ...
    cmd = ["python src/mapping_varcall/merge_watson_crick-old.py",
...
def SNP_calling(in_files, args):
    ...
    in_files['vcf_out']['merged'] = os.path.join(args.output_dir, 'merged.tsv.gz')
    cmd = ["python src/mapping_varcall/variant_calling/SNP_calling.py",
