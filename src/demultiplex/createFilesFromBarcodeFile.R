...
barcodeStacks<-data.frame(barcode1=c(paste0(barcodes$Barcode_R1,"T"),paste0(barcodes$Barcode_R1,"C")),
                          barcode2=c(paste0(barcodes$Barcode_R2,"C"),paste0(barcodes$Barcode_R2,"T")),
                          sample=c(paste0(barcodes$Sample,"-Watson"),paste0(barcodes$Sample,"-Crick")))
